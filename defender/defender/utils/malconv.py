...
class MalConvBase(nn.Module):
    def __init__(self, embed_dim, out_channels, window_size, device, dropout=0.5):
...
class MalConvPlus(nn.Module):
    def __init__(self, embed_dim, max_len, out_channels, window_size, device, dropout=0.5):
